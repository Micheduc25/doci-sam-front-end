<template>
  <div class="relative">
    <button
      ...
      type="button"
      class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-white bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
    >
